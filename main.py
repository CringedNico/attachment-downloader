...
host = "imap.gmail.com"
username = "@gmail.com" #Gmail account
pwd_gmail = "" #Gmail password per le app --> https://myaccount.google.com/apppasswords
pwd_pdf = "" #Password pdf
path = "" #Directory per il download del cedolino
